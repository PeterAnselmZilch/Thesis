# //////////////////////////////////////////////////////////////////////////////////////////////////////////////
# this model assumes a baseload profile for the hydrogen demand during the whole simulation, with a demand which should be satisfied every hour
# //////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function complete_model(n_bundles, volume, capacity_solar, capacity_wind, scenario)
    ...
    function build_model!(m::Model)
        ...
        # hydrogen demand for baseload profile
        m.ext[:constraints][:hydrogen_demand_bl] = @constraint(m, [jh=JH,jy=JY], H_del[jh,jy] == H_dem_bl) # hydrogen demand = hydrogen_delivery
